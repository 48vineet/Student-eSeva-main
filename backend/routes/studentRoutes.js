...
router.get("/:studentId/ai-summary", authorizeStudentData, getStudentAiSummary);
router.get("/:studentId", authorizeStudentData, getStudentById);
router.post(
  "/:studentId/recalculate",
  authorize(["counselor", "faculty", "exam-department"]),
  recalculateRisk,
);
...
router.delete(
  "/",
  authorize(["counselor", "exam-department"]),
  deleteAllStudentRecords,
);
