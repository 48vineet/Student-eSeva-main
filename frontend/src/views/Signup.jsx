...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.role === "parent" && !formData.student_id) {
      newErrors.student_id =
        "Child's Student ID is required for parent accounts";
    }

    if (formData.role === "faculty" && !formData.department) {
      newErrors.department = "Department is required for faculty accounts";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.role === "parent") {
        registrationData.ward_student_id = formData.student_id;
      }
  ...
  const getRoleDescription = (role) => {
    const descriptions = {
      ...
      "local-guardian":
        "Monitor class-level student progress and approve actions",
    };
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={`Enter ${formData.role === "student" ? "your" : "your child's"} student ID`}
                  />
                </div>
                {errors.student_id && (
                  <p className="mt-2 text-sm text-red-600 flex items-center">
