  ...
  const features = [
    {
      ...
      description:
        "Drag & drop Excel/CSV files for instant student risk analysis",
    ...
    },
    {
      ...
      description:
        "Interactive dashboards with live student performance monitoring",
    ...
    },
    {
      ...
      description:
        "Automated notifications for at-risk students and stakeholders",
  ...
  const riskLevels = [
    {
      ...
      criteria:
        "Attendance < 75% OR 2+ subjects failing OR fees overdue 30+ days",
      count: "15%",
    },
    {
      level: "Medium Risk",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              {isAuthenticated && settingsAllowedRoles.includes(user?.role) && (
                <Link
                  to="/settings"
                  className="px-4 py-2 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 font-medium"
                >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed mb-12">
              Transform student success with intelligent risk detection,
              real-time analytics, and proactive intervention strategies powered
        ...
        {/* Stats Section */}
        <div
          className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 transform transition-all duration-1000 delay-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        >
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 ring-1 ${stat.ring} hover:bg-white/20 transition-all duration-300 transform hover:scale-[1.03]`}
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="flex items-center space-x-3">
                <div
                  className={`p-3 rounded-xl ${stat.iconBg} group-hover:bg-white/30 transition-colors duration-300`}
                >
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Everything you need to identify, monitor, and support at-risk
              students
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Our intelligent system categorizes students based on comprehensive
              risk factors
            </p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/20">
                    <th className="text-left py-4 px-6 text-white/90 font-semibold">
                      Risk Level
                    </th>
                    <th className="text-left py-4 px-6 text-white/90 font-semibold">
                      Percentage
                  ...
                  {riskLevels.map((risk, index) => (
                    ...
                    >
                      <td className="py-6 px-6">
                        <div className="flex items-center space-x-3">
                          <div
                            className={`p-2 rounded-lg bg-gradient-to-r ${risk.color}`}
                          >
                      ...
                      <td className="py-6 px-6">
                        <div
                          className={`inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r ${risk.bgColor} border ${risk.borderColor}`}
                        >
                          <span
                            className={`font-bold text-lg ${risk.color.replace("from-", "text-").replace(" to-", "-")}`}
                          >
                            {risk.count}
                          </span>
                        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-cyan-600/20 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                ...
                to identify and support at-risk students before it's too late.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  to="/dashboard"
